...
This program simulates an e-commerce customer dataset and performs a comprehensive analysis:
- Data cleaning
...
Ensure the following R libraries are installed in advance when running the program:
